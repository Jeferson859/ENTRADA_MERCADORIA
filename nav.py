...
def render(active: str = ""):
    ...
    with st.sidebar:
        ...
        st.markdown(
            """
            <div style="border-top:1px solid rgba(255,255,255,.07);margin-top:18px;padding-top:14px">
              ...
              <div style="font-size:10px;color:#5A6275;margin-top:10px;line-height:1.5">v2.0 · produto interno<br>conectado: AdriLar</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
